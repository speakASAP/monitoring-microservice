...
Owner: Operations Lead. Status: draft. Source task: `11_tasks/TASK-003-customer-integration-ingest-and-webhook-activation.md`. Lifecycle state: reviewed planning, awaiting owner approval for implementation. Execution mode: parallel-ready after approval, with backend contract merged before dependent frontend work.
...
milestone: 09_milestones/MS-003-customer-integration-ingest-and-webhook-activation.md
...
context_package: 13_context_packages/CP-TASK-003-customer-integration-ingest-and-webhook-activation.md
```
...
- TASK-003 validation report under `12_validation/` after implementation.
- `14_prompts/PROMPT-TASK-003-customer-integration-ingest-and-webhook-activation.md`
...
- `01_vision/VISION.md` unless a human explicitly approves vision change
...
You are a coding agent working in monitoring-microservice under the Intent Preservation System. Implement only the approved TASK-003 workstream assigned to you. Read `13_context_packages/CP-TASK-003-customer-integration-ingest-and-webhook-activation.md`, this execution plan, `17_governance/PROJECT_INVARIANTS.md`, and `23_documentation_contracts/SENSITIVE_DATA_POLICY.md`. Stay within the allowed files for your workstream, do not log or persist raw keys, use synthetic test payloads only, and return files changed, validation evidence, deviations, blockers, and handoff notes.
