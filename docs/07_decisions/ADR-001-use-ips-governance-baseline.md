...
Validated by strict documentation audit, pre-coding gate, deployment-readiness gate, `npm run build`, and `npm test` evidence recorded in `docs/12_validation/VAL-TASK-001-ips-governance-baseline.md`.
