...
Use `docs/13_context_packages/CP-TASK-002-saas-access-and-customer-onboarding.md` and `docs/21_execution_plans/EP-TASK-002-saas-access-and-customer-onboarding.md`. Auth remains the identity and RBAC authority. Monitoring consumes Auth validation and role claims.
