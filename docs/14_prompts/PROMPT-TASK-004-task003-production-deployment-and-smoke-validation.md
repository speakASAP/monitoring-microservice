...
Use `docs/13_context_packages/CP-TASK-004-task003-production-deployment-and-smoke-validation.md` and `docs/21_execution_plans/EP-TASK-004-task003-production-deployment-and-smoke-validation.md`. TASK-003 is implemented and validated but was not deployed during its closure.
