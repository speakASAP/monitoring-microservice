...
Goal impact record: `docs/22_goal_impact/GOAL-IMPACT-TASK-003.md`.
...
- `docs/13_context_packages/CP-TASK-003-customer-integration-ingest-and-webhook-activation.md`
