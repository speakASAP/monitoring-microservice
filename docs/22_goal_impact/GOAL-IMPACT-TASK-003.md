...
downstream_links:
  - docs/21_execution_plans/EP-TASK-003-customer-integration-ingest-and-webhook-activation.md
...
- Prior dependency: `docs/10_features/FEAT-002-saas-access-and-customer-onboarding.md`
- Task: `docs/11_tasks/TASK-003-customer-integration-ingest-and-webhook-activation.md`
- Execution plan: `docs/21_execution_plans/EP-TASK-003-customer-integration-ingest-and-webhook-activation.md`
