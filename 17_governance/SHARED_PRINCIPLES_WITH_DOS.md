...
Monitoring-microservice source truth is this repository: `00_constitution/`, `01_vision/`, `SYSTEM.md`, `AGENTS.md`, source code, and Kubernetes manifests. DOS is a reference project and is not authoritative for monitoring runtime behavior.
