# Copilot Instructions — `monitoring-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/monitoring-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/monitoring-microservice.git`, branch `main`.
...
3. This repo, in order: `BUSINESS.md` `SYSTEM.md` `AGENTS.md` `AGENT_OPERATIONS.md` `TASKS.md` `CLAUDE.md`
